...
class M5Formatter(GenericDataFormatter):
  """Defines and formats data for the m5 dataset.
  ...
  _column_definition = [
      ...
      ('quantity', DataTypes.REAL_VALUED, InputTypes.TARGET),
#       ('wm_yr_wk', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
#       ('weekday', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT),
      ('wday', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT),
      ('month', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT),
      ('year', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT),
#       ('d', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
...
#       ('snap_WI', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT),
  ...
  def split_data(self, df, valid_boundary=1885, test_boundary=1913):
    # 1 - (1913-28)
    # (1913-28) - 1913
    # 1913 - 1941
    ...
    index = df['date']
    train = df.loc[index < '2016-02-28']
    valid = df.loc[index < '2016-03-27']
    test = df
  ...
  def get_fixed_params(self):
    ...
    fixed_params = {
        'total_time_steps': 28 * 8,
        'num_encoder_steps': 28 * 7,
        'num_epochs': 100,
