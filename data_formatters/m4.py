...
class M4Formatter(GenericDataFormatter):
  ...
  _column_definition = [
      ...
      ('time_cat', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      # ('id', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT),
      ('category', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT),
  ]
